package com.backend.backend.Segurity.Entity;
...
public class UserPrincipal implements UserDetails {
    ...
    public static UserPrincipal build(Usuario usuario) {
        ...
        return new UserPrincipal(usuario.getNombre(), usuario.getNombreUsuario(), usuario.getEmail(),
                usuario.getPassoword(), authorities);
    }
